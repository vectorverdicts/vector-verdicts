...
import { Background, type BackgroundKind } from './backgrounds';
 ...
 */
export const Backdrop: React.FC<{ opacity?: number; kind?: BackgroundKind }> = ({ opacity = 0.2, kind = 'aurora' }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: colors.bg }}>
      <Background kind={kind} bg={colors.bg} />
      <Img
